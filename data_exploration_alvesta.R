...
dates_av = read.fst("~/Thesis/Data_Niko/2024-01-09-v2/Av/dates.fst")
...
selected_data = connections_av_from_lp  %>% 
               select(arr.ActivityId, Reached, PlannedTransferTime, arr.PlannedArrivalTime, arr.Date) %>% arrange(PlannedTransferTime)
